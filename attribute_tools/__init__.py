...
from ._ntoc_functions import convert_normal_to_color, update_currentNtoC, update_oNtoC, update_dNtoC, regenerate_currentNtoC, regenerate_oNtoC, regenerate_all_dNtoCs, regenerate_dNtoC, switch_color_attribute_domain